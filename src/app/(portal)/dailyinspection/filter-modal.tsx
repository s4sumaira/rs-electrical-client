...
interface FilterModalProps {
  onApply: (filters: { supplier: string; jobNumber: string; weekStartDate: string }) => void
  onClose: () => void
  initialFilters: { supplier: string; jobNumber: string; weekStartDate: string }
}
...
export function FilterModal({ onApply, onClose, initialFilters }: FilterModalProps) {
  ...
  const [weekStartDate, setWeekStartDate] = useState(initialFilters.weekStartDate)

  const handleApply = () => {
    onApply({ supplier, jobNumber, weekStartDate })
    onClose()
  }
